...
button_div = Button(root, text = '/', padx = 34, pady = 35, bg = '#00796B', fg = 'white', command = div_).grid(row = 1, column = 3)
...
button_sus = Button(root, text = '-', padx = 36.4, pady = 35, bg = '#00796B', fg = 'white', command = sus_).grid(row = 3, column = 3)
...
button_mul = Button(root, text = 'x', padx = 35, pady = 35, bg = '#00796B', fg = 'white', command = mul_).grid(row = 2, column = 3)
